      ...
      <CardContent className="pt-6">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          {type === 'received' && offer.status === 'pending' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:flex md:flex-col md:items-end gap-2 mt-2 md:mt-0 w-full md:w-auto md:ml-auto md:[&>button]:w-[240px] md:[&>button]:whitespace-nowrap">
              <Button 
                variant="default" 
